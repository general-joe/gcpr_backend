...
class UtilFunctions {
  ...
  static formatTelephone = () => {};

  static totp4digits = () => Math.floor(1000 + Math.random() * 9000);

  static totp6digits = () => Math.floor(100000 + Math.random() * 900000);
  static bookingCode = () =>
  ...
  static formatGhPhoneNumber = (phoneNumber) => {
